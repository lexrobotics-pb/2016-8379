 ...
 * Standardizes sensor get value calls as get~, and print value calls as send~
...
public class Sensors {
    ...
    public void sendLight(LightSensor light){
        telemetry.addData("light", "light: " + light.toString());
    }

    public void sendAcceleration (AccelerationSensor accel){
        telemetry.addData("acceleration", "acceleration: " + accel.toString());
    }

    public void sendCompass(CompassSensor compass){
        telemetry.addData("compass", "compass: " + compass.toString());
    }

    public void sendVoltage (VoltageSensor voltage){
